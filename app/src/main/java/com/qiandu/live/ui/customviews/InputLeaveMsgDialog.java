package com.qiandu.live.ui.customviews;
 ...
 */
public class InputLeaveMsgDialog extends Dialog {

    public interface OnTextSendListener {

        void onLeaveMsgSend(String msg, String userId, String accId);
    }

    private TextView confirmBtn;
    private LinearLayout mBarrageArea;
    private EditText messageTextView;
    private static final String TAG = InputLeaveMsgDialog.class.getSimpleName();
...
//    private Pattern pattern = Pattern.compile(reg);
    ...
    public InputLeaveMsgDialog(Context context, int theme, final String userId, final String accId) {
        super(context, theme);
        mContext = context;
        mUserId = userId;
        mAccId = accId;
        setContentView(R.layout.dialog_input_leave_msg);
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(msg)) {
                    ...
                    mOnTextSendListener.onLeaveMsgSend(msg, userId, accId);
