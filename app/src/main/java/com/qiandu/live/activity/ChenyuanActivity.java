...
public class ChenyuanActivity extends AppCompatActivity implements View.OnClickListener{
    private RelativeLayout btnHoutui;
    private WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chenyuan);
        //透明状态栏
        ...
        webView.loadUrl(IRequest.HTMLURL+"/member_manage.html?userid="+ ACache.get(this).getAsString("user_id"));
//        LogUtil.d("CHENGYUAN","111111111"+sssss);
    }
