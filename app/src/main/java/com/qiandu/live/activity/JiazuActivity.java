...
public class JiazuActivity extends AppCompatActivity implements View.OnClickListener{
    private RelativeLayout btnHoutui;
    private WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.avtivity_jiazui);
        //透明状态栏
        ...
        webView.loadUrl(IRequest.HTMLURL+"/family.html?userid="+ ACache.get(this).getAsString("user_id"));
    }
    @Override
