...
public class YingsitiaokuanActivity extends AppCompatActivity implements View.OnClickListener{
    private WebView webView;
    private RelativeLayout btnHoutui;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yingsitiaokuan);
        //透明状态栏
        ...
        webView.loadUrl("http://www.qianduzhibo.com/h5/yinsi.html?userid="+ ACache.get(this).getAsString("user_id"));
    }
    @Override
