...
public class FuwutiaokuanActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl(IRequest.HTMLURL+"/fuwu.html?userid="+ ACache.get(this).getAsString("user_id"));
    }
